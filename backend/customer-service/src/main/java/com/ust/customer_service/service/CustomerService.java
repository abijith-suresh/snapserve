...
public class CustomerService {
  ...
  public Flux<CustomerDto> findAllCustomers() {
    return customerRepository.findAll().map(this::modelToDto);
  }

  public Mono<CustomerDto> findCustomerById(ObjectId id) {
    return customerRepository.findById(id).map(this::modelToDto);
  }
  ...
  public Mono<CustomerDto> findByEmail(String email) {
    return customerRepository.findByEmail(email).map(this::modelToDto);
  }
